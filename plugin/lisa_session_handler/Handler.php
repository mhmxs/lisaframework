...
class Handler implements \lisa_core_api\ISessionHandler {
     ...
     * @return void
     */
    private function __construct($name = "LISA_Session") {
        $this->_name = $name;
        $this->_isNew = false;

        $configReader = \lisa_util\Config\Cache::getConfig(DIR_ROOT . "/config/Config.ini");
    ...
    public function gc($expire) {
        foreach (\lisa_util\DirectoryHandler::getFiles($this->_sessionPath) as $session) {
