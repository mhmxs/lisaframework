...
abstract class AView implements IView
{
	...
	{
		$this->_addons["scriptVars"][] = new Helper\ScriptVars($data, $attribs);
	}
	...
	{
		$this->_addons["script"][] = new Helper\Script((string)$src, $attribs);
	}
	...
	{
		$this->_addons["bottomScript"][] = new Helper\Script((string)$src, $attribs);
	}
	...
	{
		$this->_addons["style"][] = new Helper\Style((string)$href, $attribs);
	}
