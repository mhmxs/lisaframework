...
class XMLTag
{
    ...
    public function AddChild($name, $attrs, $parents, $cleanTagName = true)
    {
        ...
        {
            BasicErrorHandler::trace('You have used a reserved name as the name of an XML tag. Please consult the documentation (http://www.criticaldevelopment.net/xml/) and rename the tag named "'.$name.'" to something other than a reserved name.', E_USER_ERROR);
